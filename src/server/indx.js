...
//             var resault=JSON.stringify(user)
//             console.log(resault);
//             socket.on('recive',(msg)=>{
//               console.log(msg)
//               io.emit('all messagees',resault)
//             })
...
//   //       }) 
//   //       socket.on('recived',async(msg)=>{
//   //           const id=user.map(each=>{return each._id})
//   //           const res=user.map(each=>{return each.Text})
          
//   //           msg=Array.from(res);
//   //           console.log(msg+' all data') 
...
//   try {
//     const allMessages = await msg.find().sort({ createdAt: 1 });
...
//     socket.on('recived',async()=>{
//  try {
//             const messages=await collection.find().toArray();
//             const texts=messages.map(m=>m.Text)
//             socket.emit('all messages',texts)
//  } catch (err) {
...
//  try {
//            await collection("collection1").insertOne({"Text":message});
//           socket.emit('message',message);
